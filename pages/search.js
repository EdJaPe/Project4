...
const API_URL_TWO = process.env.NEXT_PUBLIC_API_URL_TWO
...
export default function Search() {
    ...
    let respond = results.length > 0 ? results.map((place, i) => { <h3 key={i}>PM25:{place.PM25}</h3> }) : <h3>Your results will be here </h3>
